...
/*
    ...
    Documentation: http://www.meekro.com/docs.php
*/


class DB {
  // initial connection
  public static $dbName = 'XXXXXXXXX';
  public static $user = 'XXXXXXXXX';
  public static $password = 'XXXXXXXXX';
  public static $host = 'XXXXXXXXX';
